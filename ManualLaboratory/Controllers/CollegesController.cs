...
namespace ManualLaboratory.Controllers
{
    public class CollegesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CollegeName")] College college)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CollegeName")] College college)
        {
            if (id != college.Id)
            {
                return NotFound();
